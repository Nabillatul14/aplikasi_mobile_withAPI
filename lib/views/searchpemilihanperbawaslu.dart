...
class HomeScreenperbawaslu extends StatefulWidget {
  const HomeScreenperbawaslu({super.key});

  @override
  State<HomeScreenperbawaslu> createState() => _HomeScreenperbawasluState();
}

class _HomeScreenperbawasluState extends State<HomeScreenperbawaslu> {
  // list get data api
  List<Post> posts = [];
